        ...
        if prod:
            ...
            for sys in systems:
                ...
                for sub in subsystems:
                    ...
                    sub_node_form = render_subsystem_form(sub_id, pi_options, sub_options, sub.name, sub.description, 
                    ...
                    for s in sensors:
                        s_id = s.sensor_id
                        s_nodes.append(render_sensor_form(s_id, pi_options, s.name, s.tag, s.description, s.pi_id))
