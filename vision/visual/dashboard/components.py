    ...
    return dbc.Card([
        dbc.CardBody([
            dbc.Row([
                ...
                dbc.Col([
                    dbc.ButtonGroup([
                        dbc.Button(html.I(className="bi bi-arrow-up"),   id={"type": "move-up-sys",   "index": system_id}, color="light", size="sm"),
                        dbc.Button(html.I(className="bi bi-arrow-down"), id={"type": "move-down-sys", "index": system_id}, color="light", size="sm"),
    ...
    return dbc.Card([
        dbc.CardBody([
            dbc.Row([
                ...
                dbc.Col([
                    dbc.ButtonGroup([
                        dbc.Button(html.I(className="bi bi-arrow-up"),   id={"type": "move-up-sub",   "index": sub_id}, color="light", size="sm"),
                        dbc.Button(html.I(className="bi bi-arrow-down"), id={"type": "move-down-sub", "index": sub_id}, color="light", size="sm"),
    ...
    return dbc.Card([
        dbc.CardBody([
            dbc.Row([
                ...
                dbc.Col([
                    dbc.ButtonGroup([
                        dbc.Button(html.I(className="bi bi-arrow-up"),   id={"type": "move-up-sensor",   "index": sensor_id}, color="light", size="sm"),
                        dbc.Button(html.I(className="bi bi-arrow-down"), id={"type": "move-down-sensor", "index": sensor_id}, color="light", size="sm"),
